            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="../usuarios/listUsuario.php"><i
                                        class="fa
                      fa-circle-o"></i> Listar </a></li>
                    ...
                    <div class="box-header">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <a class="btn btn-default" href="../usuarios/addUsuario.php">
                                    Cadastrar +
                                </a>    
                            </div>
                        </div>
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $lista['login']; ?>
                                    </td>
                                    <!-- Botoes das açoes -->
                                    <td class="text-center">
                                        <a class="btn btn-primary" href="addUsuario.php?id=<?php echo $lista['id']; ?>">
                                            Editar
                                        </a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Deseja
                                                            realmente
                                                            excluir
                                                            o usuário 
                                                            <?php echo $lista['nome']; ?>?</h5>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <form action="../config/delete.php" method="POST">
                                                            ...
                                                            <button type="submit" class="btn btn-success"
                                                                name="btn-delete-usuario">Confirmar</button>
